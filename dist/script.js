...
/* harmony import */ var _checkNumInputs_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./checkNumInputs.js */ "./src/js/modules/checkNumInputs.js");
...
var forms = function forms(state) {
  ...
  Object(_checkNumInputs_js__WEBPACK_IMPORTED_MODULE_5__["default"])('input[name="user_phone"]');
  var message = {
    loading: 'Загрузка',
    ...
    return regeneratorRuntime.async(function postData$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            //функция отправки данных на сурвер
...
var tabs = function tabs(headerSelector, tabSelector, contentSelector, activeClass) {
  ...
  header.addEventListener('click', function (e) {
    //делигируем события клика от контейнера родителя к списку табов
    var target = e.target;

    if (target && (target.classList.contains(tabSelector.replace(/\./, '')) || //проверка кликнул ли user именно на таб,
...
"use strict";
__webpack_require__.r(__webpack_exports__);
//1. определяем время до дедлайна, вічесляем количество дней часов и тд...
//2 устанавливаем часы с данных 1
